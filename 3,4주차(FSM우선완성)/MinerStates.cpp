...
{
	cout << endl << "=================================================================" << endl;
	cout << miner->Getter_id() << "이(가) 광산에 도착하였습니다." << endl;
	cout << "=================================================================" << endl << endl;
}
...
{
	cout << miner->Getter_id() << "이(가) 광산에서 떠납니다." << endl;
}
//---------------------------------------------------------------
...
{
	cout << endl << "=================================================================" << endl;
	cout << miner->Getter_id() << "이(가) 술집에 도착하였습니다." << endl;
	cout << "=================================================================" << endl << endl;
}
...
{
	cout << endl << "=================================================================" << endl;
	cout << miner->Getter_id() << "이(가) 은행에 도착하였습니다." << endl;
	cout << "=================================================================" << endl <<endl;
}
...
{
	cout << miner->Getter_id() << "이(가) 은행에서 떠납니다." << endl;
}
//---------------------------------------------------------------
...
{
	cout << endl << "=================================================================" << endl;
	cout << miner->Getter_id() << "이(가) 집에 도착하였습니다." << endl;
	cout << "=================================================================" << endl <<endl;
}
...
{
	cout << miner->Getter_id() << "이(가) 집에서 떠납니다." << endl;
}
//---------------------------------------------------------------
...
void MinerGlobalState::Execute(Miner* miner)
{
	...
	{
		if (randomInt >= 51 && randomInt <= 100)
		{
			cout << "화장실이 급해졌다.... 서둘러 화장실로 향하자.(확률 50%)" << endl;
			miner->GetFSM()->ChangeState(VisitBathroom::Instance());
		}
...
{
	cout << endl << "=================================================================" << endl;
	cout << miner->Getter_id() << "이(가) 화장실에 도착하였습니다." << endl;
	cout << "=================================================================" << endl << endl;
}

void VisitBathroom::Execute(Miner* miner)
{
	cout << "급한 볼일을 해결했다." << endl;
	//저장해둔 이전으로
...
{
	Sleep(1000);
	cout << miner->Getter_id() << "이(가) 화장실에서 떠납니다." << endl;
}
